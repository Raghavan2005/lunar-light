...
title: LunarLight 3.0
slug: astro-paper-v3
featured: false
ogImage: https://github.com/satnaing/astro-paper/assets/53733092/1ef0cf03-8137-4d67-ac81-84a032119e3a
tags:
  - release
description: "LunarLight Version 3: Elevating Your Web Experience with Astro v3 and Seamless View Transitions"
---

We're excited to announce the release of LunarLight v3, packed with new features, enhancements, and bug fixes to elevate your web development experience. Let's dive into the highlights of this release:

![LunarLight v3](@/assets/images/LunarLight-v3.png)
...
LunarLight now fully supports [Astro v3](https://astro.build/blog/astro-3/), offering improved performance and rendering speed.
...
`SITE.ogImage` is now optional. If it is not specified, LunarLight will automatically generate an OG image using `SITE.title`, `SITE.desc` and `SITE.website`
...
## Upgrade to LunarLight v3

> This section is only for those who want to upgrade LunarLight v3 from the older versions.

This section will help you migrate from LunarLight v2 to LunarLight v3.

Before reading the rest of the section, you might also want to check [this article](https://astro-paper.pages.dev/posts/how-to-update-dependencies/) for upgrading dependencies and LunarLight.
...
**_Step 1: Replace everything else with LunarLight v3_**

In this step, replace everything\_ except above files/directories (plus your customized files/directories)\_ with LunarLight v3.
...
Ready to explore the exciting new features and improvements in LunarLight v3? Start [using LunarLight](https://github.com/satnaing/astro-paper) now.
