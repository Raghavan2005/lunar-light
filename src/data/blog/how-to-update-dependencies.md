---
title: How to update dependencies of LunarLight
author: Sat Naing
...
tags:
  - FAQ
description: How to update project dependencies and LunarLight template.
---

Updating the dependencies of a project can be tedious. However, neglecting to update project dependencies is not a good idea either 😬. In this post, I will share how I usually update my projects, focusing on LunarLight as an example. Nonetheless, these steps can be applied to other js/node projects as well.
...
## Updating LunarLight template

Like other open-source projects, LunarLight is evolving with bug fixes, feature updates, and so on. So if you’re someone who is using LunarLight as a template, you might also want to update the template when there’s a new release.
...
If you’re someone who only updates the bare minimum of the template, it should be okay to replace everything with the latest LunarLight except the above files and directories. It’s like pure Android OS and other vendor-specific OSes like OneUI. The less you modify the base, the less you have to update.
...
In this article, I've shared some of my insights and processes for updating dependencies and the LunarLight template. I genuinely hope this article proves valuable and assists you in managing your projects more efficiently.

If you have any alternative or improved approaches for updating dependencies/LunarLight, I would love to hear from you. Thus, don't hesitate to start a discussion in the repository, email me, or open an issue. Your input and ideas are highly appreciated!
