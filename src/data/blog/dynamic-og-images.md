...
title: Dynamic OG image generation in LunarLight blog posts
...
tags:
  - docs
  - release
description: New feature in LunarLight v1.4.0, introducing dynamic OG image generation for blog posts.
---

New feature in LunarLight v1.4.0, introducing dynamic OG image generation for blog posts.
...
In LunarLight v1.4.0, Vercel's [Satori](https://github.com/vercel/satori) package is used for dynamic OG image generation.
...
## Anatomy of LunarLight dynamic OG image

Dynamic OG image of LunarLight includes _the blog post title_, _author name_ and _site title_. Author name and site title will be retrieved via `SITE.author` and `SITE.title` of **"src/config.ts"** file. The title is generated from the blog post frontmatter `title`.  
