...
title: Adding new posts in LunarLight theme
...
tags:
  - docs
description:
  Some rules & recommendations for creating or adding new posts using LunarLight
  theme.
---

Here are some rules/recommendations, tips & ticks for creating new posts in LunarLight blog theme.
...
> Prior to LunarLight v5.1.0, all blog posts had to be in `src/data/blog/`, meaning you couldn't organize them into subdirectories.

Starting from LunarLight v5.1.0, you can now organize blog posts into subdirectories, making it easier to manage your content.
...
Title and description (excerpt) are important for search engine optimization (SEO) and thus LunarLight encourages to include these in blog posts.
...
Here are some recommendations, tips & ticks for creating new posts in LunarLight blog theme.
...
There's one thing to note about headings. The LunarLight blog posts use title (title in the frontmatter) as the main heading of the post. Therefore, the rest of the heading in the post should be using h2 \~ h6.
...
> Since LunarLight v1.4.0, OG images will be generated automatically if not specified. Check out [the announcement](https://astro-paper.pages.dev/posts/dynamic-og-image-generation-in-astropaper-blog-posts/).
