# How to contribute to LunarLight

Thank you for your interest in contributing to **LunarLight**! We appreciate every contribution, whether you're fixing a typo, improving documentation, or adding a new feature.

## Types of Contributions

There are several ways to contribute to **LunarLight**, and every contribution counts\_ whether it's a PR for a major feature or a small fix.
...
If you have an idea for a new feature or enhancement that could improve LunarLight, we’d love to hear it! Before submitting a new feature request, please:
...
GitHub Discussions and Issues are great places to help others. Whether you're a long-time user of LunarLight or just have experience with a specific problem, we encourage you to answer questions or solve issues when possible.
...
Since LunarLight doesn’t currently have automated testing, it’s especially useful if you can do manual testing on open PRs and provide feedback.
